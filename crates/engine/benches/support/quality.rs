...
pub fn assert_synthetic_quality_gate(report: &EvalReport, emit_warnings: bool) {
    ...
    if !gate.passed {
        ...
        panic!(
            "recall quality gate {} failed with {} failures",
            gate.profile,
            gate.failures.len()
        );
    }
...
pub fn print_recall_quality_report(report: &EvalReport) {
    ...
    for aspect in &report.aspects {
        eprintln!(
            "recall_quality aspect={} cases={} recall@1={:.3} recall@5={:.3} source_recall@1={:.3} source_recall@5={:.3} mrr={:.3} source_mrr={:.3} hit_rate={:.3} clean_hit={:.3} success={:.3} precision@1={:.3} precision@5={:.3} clean_precision@5={:.3} diversity={:.3} duplicate_rate={:.3} forbidden_rate={:.3} noise={:.3} abstention={:.3} forbidden={:.3}",
            aspect.aspect,
            aspect.case_count,
            aspect.recall_at_1,
            aspect.recall_at_5,
    ...
    for case in &report.cases {
        eprintln!(
            "recall_quality case={} aspect={} rank={:?} source_rank={:?} clean_hit={} success={} diversity={:.3} duplicate_rate={:.3} duplicates={} forbidden_hits={} failures=[{}] results=[{}] unique=[{}] forbidden=[{}]",
            case.id,
            case.aspect,
            case.matched_rank,
